...
public class GameControllerIT {
    ...
    private static String POSITION_WITH_NO_SUCH_PLAYER = "{\"player\":\"PLAYER3\",\"xCoord\":0,\"yCoord\":0}";
    ...
    public void shouldNotMakeMoveWhenPositionAlreadyAssigned() throws Exception {
        ...
        assertThat(mvcResult.getResponse().getErrorMessage()).isEqualTo("Position already assigned to player");
    ...
    public void shouldNotMakeMoveWhenNoSuchGame() throws Exception {
        // given & when
        MvcResult mvcResult = this.mockMvc
                .perform(post("/move/4")
                        .content(PLAYER_ON_POSITION)
        ...
        assertThat(mvcResult.getResponse().getErrorMessage()).isEqualTo("Board with given id does not exist");
    }
    ...
    public void shouldNotMakeMoveWhenNoSuchPlayer() throws Exception {
        // given & when
        MvcResult mvcResult = this.mockMvc
                .perform(post("/move/1")
                        .content(POSITION_WITH_NO_SUCH_PLAYER)
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
                .andReturn();
        ...
        // then
        assertThat(mvcResult.getResponse().getStatus()).isEqualTo(HttpStatus.NOT_FOUND.value());
        assertThat(mvcResult.getResponse().getErrorMessage()).isEqualTo("Player with given id does not exist");
    }
